...
/*     */ 
/*     */ 
/*     */ public class saveweaponCW
/*     */   extends ItemExecutor
/*     */ {
/*     */   public static ItemExecutor get() {
/*  31 */     return new saveweaponCW();
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/*     */       return;
/*     */     } 
/*  60 */     if (tgItem.getItem().getType2() == 1 && tgItem.getEnchantLevel() >= 8) {
...
/*     */         return;
/*     */       } 
/* 121 */       tgItem.setproctect2(true);
/* 122 */       pc.sendPackets((ServerBasePacket)new S_ItemStatus(tgItem));
/* 123 */       pc.getInventory().saveItem(tgItem, 4);
/*     */       
/* 125 */       pc.sendPackets((ServerBasePacket)new S_ServerMessage("初級裝備保護卷軸的力量附著的物品中。"));
/* 126 */       pc.getInventory().removeItem(item, 1L);
/* 127 */       RecordTable.get().recordFailureArmor1(pc.getName(), item.getAllName(), tgItem.getAllName(), item.getId(), "賦予低階防爆", pc.getIp());
/*     */     } 
/*     */   }
/*     */ }


/* Location:              D:\Downloads\380\gs.jar!\com\lineage\data\item_etcitem\add\saveweaponC.class
