...
public class BuffStone extends ItemExecutor {
	...
	public void execute(final int[] data, final L1PcInstance pc, final L1ItemInstance item) {
		try {
			...
			// 檢查是否已經使用了附魔石
			boolean hasUsedBuffStone =
				    pc.hasSkillEffect(L1SkillId.BS_ASX01) ||
				    pc.hasSkillEffect(L1SkillId.BS_ASX02) ||
				    pc.hasSkillEffect(L1SkillId.BS_ASX03) ||
				    pc.hasSkillEffect(L1SkillId.BS_ASX04) ||
				    pc.hasSkillEffect(L1SkillId.BS_ASX05) ||
				    pc.hasSkillEffect(L1SkillId.BS_ASX06) ||
				    pc.hasSkillEffect(L1SkillId.BS_ASX07) ||
				    pc.hasSkillEffect(L1SkillId.BS_ASX08) ||
				    pc.hasSkillEffect(L1SkillId.BS_ASX09) ||
				    pc.hasSkillEffect(L1SkillId.BS_AX01) ||
				    pc.hasSkillEffect(L1SkillId.BS_AX02) ||
				    pc.hasSkillEffect(L1SkillId.BS_AX03) ||
				    pc.hasSkillEffect(L1SkillId.BS_AX04) ||
				    pc.hasSkillEffect(L1SkillId.BS_AX05) ||
				    pc.hasSkillEffect(L1SkillId.BS_AX06) ||
				    pc.hasSkillEffect(L1SkillId.BS_AX07) ||
				    pc.hasSkillEffect(L1SkillId.BS_AX08) ||
				    pc.hasSkillEffect(L1SkillId.BS_AX09) ||
				    pc.hasSkillEffect(L1SkillId.BS_GX01) ||
				    pc.hasSkillEffect(L1SkillId.BS_GX02) ||
				    pc.hasSkillEffect(L1SkillId.BS_GX03) ||
				    pc.hasSkillEffect(L1SkillId.BS_GX04) ||
				    pc.hasSkillEffect(L1SkillId.BS_GX05) ||
				    pc.hasSkillEffect(L1SkillId.BS_GX06) ||
				    pc.hasSkillEffect(L1SkillId.BS_GX07) ||
				    pc.hasSkillEffect(L1SkillId.BS_GX08) ||
				    pc.hasSkillEffect(L1SkillId.BS_GX09) ||
				    pc.hasSkillEffect(L1SkillId.BS_WX01) ||
				    pc.hasSkillEffect(L1SkillId.BS_WX02) ||
				    pc.hasSkillEffect(L1SkillId.BS_WX03) ||
				    pc.hasSkillEffect(L1SkillId.BS_WX04) ||
				    pc.hasSkillEffect(L1SkillId.BS_WX05) ||
				    pc.hasSkillEffect(L1SkillId.BS_WX06) ||
				    pc.hasSkillEffect(L1SkillId.BS_WX07) ||
				    pc.hasSkillEffect(L1SkillId.BS_WX08) ||
				    pc.hasSkillEffect(L1SkillId.BS_WX09);
			
			// 檢查是否已經使用了附魔石
            if (hasUsedBuffStone) {
            	pc.sendPackets(new S_ServerMessage("已經有附魔石狀態"));
                // 角色已經使用了附魔石，不允許使用其他道具
                return;
            }
			...
			if (_count > 0 && _itemid > 0) {
				if (!pc.getInventory().checkItem(_itemid, _count)) {// 魔法結晶體(耗用物品)
					final L1Item temp = 
						ItemTable.get().getTemplate(_itemid);
