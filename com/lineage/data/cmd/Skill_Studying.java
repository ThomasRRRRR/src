...
//		final boolean isOk = ConfigOtherSet2.Learn_magic;
		...
		case 0:// 中立屬性魔法
			...
			|| ((x > 33134) && (x < 33152) && (y > 32940) && (y < 32957) && (m == 4))) {// 正義神殿(新)
...
//			switch (skillId) {
//			case 225:
//				itemid = 80058;//戰士技能 (咆哮)
//				break;
//			case 226:
//				itemid = 80059;//戰士技能 (體能強化)
//				break;
//			case 228:
//				itemid = 80060;//戰士技能 (拘束移動)
//				break;
//			case 229:
//				itemid = 80061;//戰士技能 (戰斧投擲)
//				break;
//			case 230:
//				itemid = 80062;//戰士技能 (亡命之徒)
//				break;
//			}
//			
//		} else
			if (pc.isWizard()) {//法師
			if (skillId == 80) {
				itemid = 80206;//魔法技能 (寒冰尖刺)
			}
			
		} else if (pc.isIllusionist()) {//幻術
			if (skillId == 218) {
				itemid = 80207;//魔法技能 (降低負重)
			}
		}
		
		if (itemid != 0) {
			L1ItemInstance item = ItemTable.get().createItem(itemid);
			item.setIdentified(true);//設為已鑑定狀態
			pc.getInventory().storeItem(item);//給予道具			
		}
	}
}
