 ...
 *
 */
public class BS_ASX04 extends SkillMode {

	private static final int _addmr = 8;
	...
	public int start(final L1PcInstance srcpc, final L1Character cha, final L1Magic magic, final int integer) throws Exception {
		final int dmg = 0;
		if (!srcpc.hasSkillEffect(L1SkillId.BS_ASX04)) {
			srcpc.addMr(_addmr);
			srcpc.setSkillEffect(L1SkillId.BS_ASX04, integer * 1000);
