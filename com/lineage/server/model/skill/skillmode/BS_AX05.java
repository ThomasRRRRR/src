...
/**
 * 附魔石(遠攻) 【+5】HP+25、MP+20
 * @author dexc
 *
 */
public class BS_AX05 extends SkillMode {
	...
	public int start(final L1PcInstance srcpc, final L1Character cha, final L1Magic magic, final int integer) throws Exception {
		final int dmg = 0;
		if (!srcpc.hasSkillEffect(L1SkillId.BS_AX05)) {
			srcpc.addMaxHp(_addhp);
			srcpc.addMaxMp(_addmp);
			srcpc.setSkillEffect(L1SkillId.BS_AX05, integer * 1000);
