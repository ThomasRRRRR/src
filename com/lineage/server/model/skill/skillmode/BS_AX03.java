...
/**
 * 附魔石(遠攻) 【+3】HP+15、MP+10
 * @author dexc
 *
 */
public class BS_AX03 extends SkillMode {

	private static final int _addhp = 15;
	...
	public int start(final L1PcInstance srcpc, final L1Character cha, final L1Magic magic, final int integer) throws Exception {
		final int dmg = 0;
		if (!srcpc.hasSkillEffect(L1SkillId.BS_AX03)) {
			srcpc.addMaxHp(_addhp);
			srcpc.addMaxMp(_addmp);
			srcpc.setSkillEffect(L1SkillId.BS_AX03, integer * 1000);
