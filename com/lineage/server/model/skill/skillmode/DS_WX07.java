...
/**
 * 龍印魔石(賢者) 魔力上限+55、魔力恢復量+2、魔法攻擊+1
 * @author dexc
 *
 */
public class DS_WX07 extends SkillMode {
	...
	public int start(final L1PcInstance srcpc, final L1Character cha, final L1Magic magic, final int integer) throws Exception {
		final int dmg = 0;
		if (!srcpc.hasSkillEffect(L1SkillId.DS_WX07)) {
			srcpc.addMaxMp(_addmp);
			srcpc.addMpr(_addmpr);
			srcpc.addSp(_addsp);
			srcpc.setSkillEffect(L1SkillId.DS_WX07, integer * 1000);
