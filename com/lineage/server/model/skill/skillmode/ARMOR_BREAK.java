...
public class ARMOR_BREAK extends SkillMode {
	...
	public int start(L1PcInstance srcpc, L1Character cha, L1Magic magic,
		...
		if ((isProbability)) {
			if (cha instanceof L1PcInstance) {
				...
				srcpc.sendPackets(new S_SystemMessage("破壞盔!"));
	...
	@Override
	public int start(L1NpcInstance paramL1NpcInstance,
			L1Character paramL1Character, L1Magic paramL1Magic, int paramInt)
			throws Exception {
	...
	@Override
	public void start(L1PcInstance paramL1PcInstance, Object paramObject)
			throws Exception {
		// TODO Auto-generated method stub
