...
/**
 * 龍印魔石(弓手) 體力上限+20、魔力上限+12
 * @author dexc
 *
 */
public class DS_AX03 extends SkillMode {

	private static final int _addhp = 20;
	private static final int _addmp = 12;
	...
	public int start(final L1PcInstance srcpc, final L1Character cha, final L1Magic magic, final int integer) throws Exception {
		final int dmg = 0;
		if (!srcpc.hasSkillEffect(L1SkillId.DS_AX03)) {
			srcpc.addMaxHp(_addhp);
			srcpc.addMaxMp(_addmp);
			srcpc.setSkillEffect(L1SkillId.DS_AX03, integer * 1000);
