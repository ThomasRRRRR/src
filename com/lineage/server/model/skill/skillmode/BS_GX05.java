...
/**
 * 附魔石(近戰) 【+5】HP+50、體力恢復量+1
 * @author dexc
 *
 */
public class BS_GX05 extends SkillMode {
	...
	public int start(final L1PcInstance srcpc, final L1Character cha, final L1Magic magic, final int integer) throws Exception {
		final int dmg = 0;
		if (!srcpc.hasSkillEffect(L1SkillId.BS_GX05)) {
			srcpc.addMaxHp(_addhp);
			srcpc.addHpr(_addhpr);
			srcpc.setSkillEffect(L1SkillId.BS_GX05, integer * 1000);
