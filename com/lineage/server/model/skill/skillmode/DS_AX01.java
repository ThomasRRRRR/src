...
/**
 * 龍印魔石(弓手) 體力上限+10、魔力上限+6
 * @author dexc
 *
 */
public class DS_AX01 extends SkillMode {

	private static final int _addhp = 10;
	private static final int _addmp = 6;
	...
	public int start(final L1PcInstance srcpc, final L1Character cha, final L1Magic magic, final int integer) throws Exception {
		final int dmg = 0;
		if (!srcpc.hasSkillEffect(L1SkillId.DS_AX01)) {
			srcpc.addMaxHp(_addhp);
			srcpc.addMaxMp(_addmp);
			srcpc.setSkillEffect(L1SkillId.DS_AX01, integer * 1000);
