 ...
 *
 */
public class BS_ASX01 extends SkillMode {

	private static final int _addmr = 2;
	...
	public int start(final L1PcInstance srcpc, final L1Character cha, final L1Magic magic, final int integer) throws Exception {
		final int dmg = 0;
		if (!srcpc.hasSkillEffect(L1SkillId.BS_ASX01)) {
			srcpc.addMr(_addmr);
			srcpc.setSkillEffect(L1SkillId.BS_ASX01, integer * 1000);
