 ...
 *
 */
public class BS_WX01 extends SkillMode {

	private static final int _addmp = 5;
	...
	public int start(final L1PcInstance srcpc, final L1Character cha, final L1Magic magic, final int integer) throws Exception {
		final int dmg = 0;
		if (!srcpc.hasSkillEffect(L1SkillId.BS_WX01)) {
			srcpc.addMaxMp(_addmp);
			srcpc.setSkillEffect(L1SkillId.BS_WX01, integer * 1000);
