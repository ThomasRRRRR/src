...
/**
 * 龍印魔石(弓手) 體力上限+25、魔力上限+15
 * @author dexc
 *
 */
public class DS_AX04 extends SkillMode {
	...
	public int start(final L1PcInstance srcpc, final L1Character cha, final L1Magic magic, final int integer) throws Exception {
		final int dmg = 0;
		if (!srcpc.hasSkillEffect(L1SkillId.DS_AX04)) {
			srcpc.addMaxHp(_addhp);
			srcpc.addMaxMp(_addmp);
			srcpc.setSkillEffect(L1SkillId.DS_AX04, integer * 1000);
