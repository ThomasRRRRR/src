 ...
 *
 */
public class BS_GX03 extends SkillMode {

	private static final int _addhp = 30;
	...
	public int start(final L1PcInstance srcpc, final L1Character cha, final L1Magic magic, final int integer) throws Exception {
		final int dmg = 0;
		if (!srcpc.hasSkillEffect(L1SkillId.BS_GX03)) {
			srcpc.addMaxHp(_addhp);
			srcpc.setSkillEffect(L1SkillId.BS_GX03, integer * 1000);
