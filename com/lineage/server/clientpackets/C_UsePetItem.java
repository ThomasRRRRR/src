...
public class C_UsePetItem extends ClientBasePacket {
	...
	public void start(final byte[] decrypt, final ClientExecutor client) {
		try {
			...
			case 46044:// 熊貓
				return;
				/*
				 * 45686 高等狼 45687 高等牧羊犬 45688 高等杜賓狗 45689 高等哈士奇 45690 高等熊 45691
				 * 高等柯利 45692 高等小獵犬 45693 高等聖伯納犬 45694 高等狐狸 45695 高等暴走兔 45696
				 * 高等貓 45697 高等浣熊 45710 高等斗虎 45712 高麗犬 46043 高等袋鼠
				 */
			}
    ...
    public static void usePetWeapon(final L1PcInstance pc, final L1PetInstance pet, final L1ItemInstance weapon, final L1PetItem petItem) {
	 ...
	 * @param petItem
	 */
    public static void usePetArmor(final L1PcInstance pc, final L1PetInstance pet, final L1ItemInstance armor, final L1PetItem petItem) {
    ...
    private static void setPetWeapon(final L1PcInstance pc, final L1PetInstance pet, final L1ItemInstance weapon, final L1PetItem petItem) {
    ...
    private static void removePetWeapon(final L1PcInstance pc, final L1PetInstance pet, final L1ItemInstance weapon, final L1PetItem petItem) {
    ...
    private static void setPetArmor(final L1PcInstance pc, final L1PetInstance pet, final L1ItemInstance armor, final L1PetItem petItem) {
    ...
    private static void removePetArmor(final L1PcInstance pc, final L1PetInstance pet, final L1ItemInstance armor, final L1PetItem petItem) {
        pet.addAc(-petItem.getAddAc());
        pet.addStr(-petItem.getAddStr());
        pet.addCon(-petItem.getAddCon());
        pet.addDex(-petItem.getAddDex());
