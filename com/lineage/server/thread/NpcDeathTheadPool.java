 ...
 * 
 */
public class NpcDeathTheadPool {

	private static final Log _log = LogFactory.getLog(NpcDeathTheadPool.class);

	private static NpcDeathTheadPool _instance;

	private static final int SCHEDULED_CORE_POOL_SIZE = 200;
	...
	private final int _pcSchedulerPoolSize = 1000 /*+ Config.MAX_ONLINE_USERS / 5*/;

	public static NpcDeathTheadPool get() {
		if (_instance == null) {
			_instance = new NpcDeathTheadPool();
		}
		return _instance;
	}

	private NpcDeathTheadPool() {
