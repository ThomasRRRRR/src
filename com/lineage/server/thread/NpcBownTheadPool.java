 ...
 * 
 */
public class NpcBownTheadPool {

	private static final Log _log = LogFactory.getLog(NpcBownTheadPool.class);

	private static NpcBownTheadPool _instance;
	...
	private final int _pcSchedulerPoolSize = 1 + Config.MAX_ONLINE_USERS / 5;

	public static NpcBownTheadPool get() {
		if (_instance == null) {
			_instance = new NpcBownTheadPool();
		}
		return _instance;
	}

	private NpcBownTheadPool() {
