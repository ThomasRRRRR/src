 ...
 * 
 */
public class NpcDeadTimerPool {

	private static final Log _log = LogFactory.getLog(NpcDeadTimerPool.class);

	private static NpcDeadTimerPool _instance;
	...
	public static NpcDeadTimerPool get() {
		if (_instance == null) {
			_instance = new NpcDeadTimerPool();
		}
		return _instance;
	}

	private NpcDeadTimerPool() {
	...
	public ScheduledFuture<?> scheduleAtFixedRate(final TimerTask command,
		...
		try {
			return this._scheduler.scheduleAtFixedRate(command, 
